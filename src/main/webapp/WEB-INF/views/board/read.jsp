			...
			<div class="col-sm-6">
				<div class="card shadow">
					<div class="card-body">
						...
						<div class="form-group">
							<label for="board_date">날짜</label> <input type="text"
						...
						<div class="form-group">
							<label for="board_file">첨부 이미지</label> <img
								src="${root }image/icon-spring-framework.svg" width="100%" />
						</div>
						...
						<div class="form-group">
							<div class="text-right">
								...
								<c:if test="${readContentBean.content_writer_idx == user_idx }">
									<a
										href="${root }board/modify?content_idx=${content_idx}"
